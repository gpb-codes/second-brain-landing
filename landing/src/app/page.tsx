        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="p-4 rounded-lg bg-slate-900/30 border border-slate-800/30 text-center">
                <div className="w-8 h-8 rounded-md mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: `${app.color}15` }}>
                  <span className="text-xs font-semibold" style={{ color: app.color }}>{app.name[0]}</span>
                </div>
